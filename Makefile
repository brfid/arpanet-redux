...
PDP11_INTERACTIVE_BUILD_ROOT ?= $(if $(wildcard $(RESULTS_ROOT)/pdp11-telnet-formal-build-20260831T200328Z/pdp11-build-receipt.json),$(RESULTS_ROOT)/pdp11-telnet-formal-build-20260831T200328Z,$(PDP11_BUILD_ROOT))
