...
| Network UNIX 176 ↔ IMP 62 ↔ IMP 6 ↔ ITS 106 | Receipt-bound heterogeneous TELNET, structured remote `:TIME`, correlated IMP traffic, and a typed journey that directly proves ITS request ingress before stopping at unproved Network UNIX reply ingress ([Gate 4H](docs/test-plan.md#gate-4h-network-unix-pdp-11-to-its)) |
