...
The dated [fault](experiments/2026-08-31-ncc-alternate-path-fault.md), [loopback](experiments/2026-08-31-ncc-line-loopback.md), [typed journey](experiments/2026-09-01-pdp11-its-message-journey.md), [KA10 request ingress](experiments/2026-09-02-ka10-request-ingress.md), [coexistence](experiments/2026-09-01-ncc-pdp11-its-coexistence.md), [application-failover](experiments/2026-09-01-ncc-pdp11-its-application-failover.md), [failover-board](experiments/2026-09-01-ncc-application-failover-board.md), [prompt-framed TELNET](experiments/2026-09-01-interactive-pdp11-its-telnet.md), and [historical terminal](experiments/2026-09-01-historical-network-unix-telnet-terminal.md) records own exact run identities, counts, failed prerequisites, retained replay, and limits.
...
The accepted direct route retains eleven observations: versioned KA10 receive-assembly and matching `DATAI` evidence closes host-106 request ingress, and the journey first stops at missing `boundary:reply:6`, host-176 reply ingress. The separately accepted failover route retains fourteen observations and first stops at missing `boundary:request:8`; it has no KA10 trace window and is not retroactively changed. Application success fills neither missing boundary. Further KA10 or IMP11-A seams require their own directly retained evidence.
