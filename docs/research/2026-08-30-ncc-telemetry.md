...
- Establish the exact Type 301/303 and Type 302 software-checksum algorithms and whether each on-wire final word is padding, transport framing, or part of the checksum domain.
