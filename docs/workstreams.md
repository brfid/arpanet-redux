...
|---|---|---|---|
| Repository maintenance | RM-01 is complete: shared historical-line fixture construction lives under `tests/support/`, and all 278 discovered tests have unique identities | RM-02 is selected; minimize `ncc/__init__.py` without moving production modules, preserving intentional compatibility | [Repository maintenance plan](repository-maintenance.md), [architecture](architecture.md), [test plan](test-plan.md) |
