...
| `/Users/brf/src/arpanet-redux-worktrees/network` | `codex/ncc-alternate-path-fault-proof` | Coordinated NCC/network-expansion fault composition and direct-line evidence |
