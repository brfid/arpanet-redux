...
|---|---|---|---|
| Repository maintenance | Phase 1 and RM-05 are complete; RM-06 has locked the two line-scenario public commands and usage contracts | Finish RM-06 by sharing only topology setup, verification, ports, launch, readiness, evidence capture, and cleanup while retaining distinct scenario, instrument, evaluator, artifact, process, error, and verdict identities | [Repository maintenance plan](repository-maintenance.md), [NCC observability](ncc.md), [test plan](test-plan.md) |
