...
- **Decision:** The coexistence route and passive desk are complete on the dedicated NCC branch; no additional route expansion is selected before that desk is integrated. Any application-relevant fault route or new host/IMP composition is a separate coordinated NCC/network-expansion gate with its own bounded claim and evidence.
