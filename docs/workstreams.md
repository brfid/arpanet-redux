...
|---|---|---|---|
| Repository maintenance | RM-01 and RM-02 are complete: test discovery is unique, shared fixtures have a support owner, and NCC contracts import through owning submodules without an aggregate package facade | RM-03 is selected; exercise pull requests and the supported Python and operating-system edges while retaining full-history source guarding | [Repository maintenance plan](repository-maintenance.md), [architecture](architecture.md), [test plan](test-plan.md) |
