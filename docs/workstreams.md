...
|---|---|---|---|
| Repository maintenance | A durable, phased maintenance plan is active; RM-01 is selected as the first bounded change | Extract shared historical-line fixture support and eliminate duplicate test discovery without changing production behavior | [Repository maintenance plan](repository-maintenance.md), [architecture](architecture.md), [test plan](test-plan.md) |
